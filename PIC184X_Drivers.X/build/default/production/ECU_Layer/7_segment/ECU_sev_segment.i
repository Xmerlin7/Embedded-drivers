...
# 74 "ECU_Layer/7_segment/../../MCAL_Layer/GPIO/../MCAL_std_types.h"
...
# 1 "ECU_Layer/7_segment/../../MCAL_Layer/GPIO/HAL_GPIO_cfc.h" 1
# 16 "ECU_Layer/7_segment/../../MCAL_Layer/GPIO/HAL_GPIO.h" 2
# 41 "ECU_Layer/7_segment/../../MCAL_Layer/GPIO/HAL_GPIO.h"
typedef enum{
    LOW = 0,
    HIGH
}logic_t;
...
# 7 "ECU_Layer/7_segment/ECU_sev_segment.c" 2
...
Std_ReturnType seven_seg_init(const segment *_seg)
{
    ...
    {
       ret = gpio_pin_Intit (&(_seg->segment_pins[0]));
       ret = gpio_pin_Intit (&(_seg->segment_pins[1]));
       ret = gpio_pin_Intit (&(_seg->segment_pins[2]));
       ret = gpio_pin_Intit (&(_seg->segment_pins[3]));
    }
    return ret;
}
Std_ReturnType seven_seg_write(const segment *_seg, uint8 number)
