...
# 74 "ECU_Layer/DC_motor/../../MCAL_Layer/GPIO/../MCAL_std_types.h"
...
# 1 "ECU_Layer/DC_motor/../../MCAL_Layer/GPIO/HAL_GPIO_cfc.h" 1
# 16 "ECU_Layer/DC_motor/../../MCAL_Layer/GPIO/HAL_GPIO.h" 2
# 41 "ECU_Layer/DC_motor/../../MCAL_Layer/GPIO/HAL_GPIO.h"
typedef enum{
    LOW = 0,
    HIGH
}logic_t;
...
Std_ReturnType dc_motor_init(const dc_motor *_dc_motor)
{
    ...
    {
        gpio_pin_Intit (&(_dc_motor->dc_motor_pin[0x00U]));
        gpio_pin_Intit (&(_dc_motor->dc_motor_pin[0x01U]));
    }
    return ret;
}
Std_ReturnType dc_motor_fwd(const dc_motor *_dc_motor)
...
{
            Std_ReturnType ret = (Std_ReturnType)0x01;;
    if ((((void*)0) == _dc_motor1) || (((void*)0) == _dc_motor2))
    {
        ret = (Std_ReturnType)0x00;;
    }
    else
    {
        gpio_pin_Write_logic (&(_dc_motor1->dc_motor_pin[0x00U]),LOW);
        gpio_pin_Write_logic (&(_dc_motor1->dc_motor_pin[0x00U]),HIGH);
        gpio_pin_Write_logic (&(_dc_motor2->dc_motor_pin[0x01U]),HIGH);
        gpio_pin_Write_logic (&(_dc_motor2->dc_motor_pin[0x01U]),LOW);
    }
    return ret;
}
