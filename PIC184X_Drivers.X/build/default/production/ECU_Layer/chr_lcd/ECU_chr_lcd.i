...
# 74 "ECU_Layer/chr_lcd/../../MCAL_Layer/GPIO/../MCAL_std_types.h"
...
# 1 "ECU_Layer/chr_lcd/../../MCAL_Layer/GPIO/HAL_GPIO_cfc.h" 1
# 16 "ECU_Layer/chr_lcd/../../MCAL_Layer/GPIO/HAL_GPIO.h" 2
# 41 "ECU_Layer/chr_lcd/../../MCAL_Layer/GPIO/HAL_GPIO.h"
typedef enum{
    LOW = 0,
    HIGH
}logic_t;
...
Std_ReturnType lcd_4bit_intialize(const chr_lcd_4bit_t *lcd){
    ...
    if(((void*)0) == lcd){
        ...
        ret = gpio_pin_Intit (&(lcd->lcd_rs));
        ret = gpio_pin_Intit(&(lcd->lcd_en));
        for(l_data_pins_counter=0; l_data_pins_counter<4; l_data_pins_counter++){
            ret = gpio_pin_Intit(&(lcd->lcd_data[l_data_pins_counter]));
        }
...
# 512 "ECU_Layer/chr_lcd/ECU_chr_lcd.c"
static Std_ReturnType lcd_8bit_set_cursor(const chr_lcd_8bit_t *lcd, uint8 row, uint8 coulmn){
    Std_ReturnType ret = (Std_ReturnType)0x01;;
    coulmn--;
    switch(row){
...
# 534 "ECU_Layer/chr_lcd/ECU_chr_lcd.c"
static Std_ReturnType lcd_4bit_set_cursor(const chr_lcd_4bit_t *lcd, uint8 row, uint8 coulmn){
    Std_ReturnType ret = (Std_ReturnType)0x01;;
    coulmn--;
    switch(row){
