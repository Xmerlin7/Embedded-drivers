...
# 74 "MCAL_Layer/interrupt/../MCAL_std_types.h"
...
# 1 "MCAL_Layer/interrupt/../../MCAL_Layer/GPIO/HAL_GPIO_cfc.h" 1
# 16 "MCAL_Layer/interrupt/../../MCAL_Layer/GPIO/HAL_GPIO.h" 2
# 41 "MCAL_Layer/interrupt/../../MCAL_Layer/GPIO/HAL_GPIO.h"
typedef enum{
    LOW = 0,
    HIGH
}logic_t;
...
Std_ReturnType Interrupt_RBx_Init(const interrupt_RBx_t *int_obj){
    ...
    if(((void*)0) == int_obj){
        ...
        ret = gpio_pin_Direction (&(int_obj->mcu_pin));
