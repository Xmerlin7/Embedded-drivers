...
# 74 "MCAL_Layer/GPIO/../MCAL_std_types.h"
...
# 1 "MCAL_Layer/GPIO/HAL_GPIO_cfc.h" 1
# 16 "MCAL_Layer/GPIO/HAL_GPIO.h" 2
# 41 "MCAL_Layer/GPIO/HAL_GPIO.h"
typedef enum{
    LOW = 0,
    HIGH
}logic_t;
...
Std_ReturnType gpio_pin_Direction(const pin_config *_pin_config)
{
    ...
    else
    {
        ...
        {
            case OUTPUT :
                (*TRIS_REGS[_pin_config ->port] &= ~((uint8)0x01 << _pin_config ->pin));
                break;
...
Std_ReturnType gpio_pin_Get_direction(const pin_config *_pin_config, direction *_status)
{
    ...
    {
       *_status = ((*TRIS_REGS[_pin_config ->port] >> _pin_config ->pin) & (uint8)0x01);
    }
...
Std_ReturnType gpio_pin_Write_logic(const pin_config *_pin_config, logic_t _logic)
{
    ...
    else
    {
        ...
        {
            case HIGH:
               (*lAT_REGS[_pin_config -> port] |= ((uint8)0x01 << _pin_config -> pin));
               break;
...
Std_ReturnType gpio_pin_Read_logic(const pin_config *_pin_config, logic_t *_logic)
{
    ...
    if ((((void*)0) == _pin_config) || (((void*)0) == _logic) || (_pin_config -> pin > 8 -1))
    {
        ret = (Std_ReturnType)0x00;;
    }
    else
    {
         *_logic = ((*PORT_REGS[_pin_config -> port] >> _pin_config -> pin) & (uint8)0x01);
    }
...
# 301 "MCAL_Layer/GPIO/HAL_GPIO.c"
Std_ReturnType gpio_port_Toggle_logic(const port_index port)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;;
