...
# 13 "MCAL_Layer/SPI/../Std_Libraries.h"
...
# 74 "MCAL_Layer/SPI/../MCAL_std_types.h"
...
# 1 "MCAL_Layer/SPI/../../MCAL_Layer/interrupt/../../MCAL_Layer/GPIO/HAL_GPIO_cfc.h" 1
# 16 "MCAL_Layer/SPI/../../MCAL_Layer/interrupt/../../MCAL_Layer/GPIO/HAL_GPIO.h" 2
# 41 "MCAL_Layer/SPI/../../MCAL_Layer/interrupt/../../MCAL_Layer/GPIO/HAL_GPIO.h"
typedef enum{
    LOW = 0,
    HIGH
}logic_t;
...
static void MSSP_SPI_Interrupt_Init(const SPI_Config *Config){
# 171 "MCAL_Layer/SPI/hal_spi.c"
}

static void MSSP_SPI_Msster_Mode_GPIO_PIN_Configurations(const SPI_Config *Config){
    Std_ReturnType ret = (Std_ReturnType)0x00;;
    pin_config SPI_SDO = {.port = PORTC_INDEX, .pin = PIN5, .direction = OUTPUT};
    pin_config SPI_SDI = {.port = PORTC_INDEX, .pin = PIN4, .direction = INPUT};
    pin_config SPI_CLK = {.port = PORTC_INDEX, .pin = PIN3, .direction = OUTPUT};

    ret = gpio_pin_Intit(&SPI_SDO);
    ret = gpio_pin_Intit(&SPI_SDI);
    ret = gpio_pin_Intit(&SPI_CLK);
}
...
static void MSSP_SPI_Slave_Mode_GPIO_PIN_Configurations(const SPI_Config *Config){
    ...
    pin_config SPI_SDO = {.port = PORTC_INDEX, .pin = PIN5, .direction = OUTPUT};
    pin_config SPI_SDI = {.port = PORTC_INDEX, .pin = PIN4, .direction = INPUT};
    pin_config SPI_CLK = {.port = PORTC_INDEX, .pin = PIN3, .direction = INPUT};
    pin_config SPI_SS = {.port = PORTA_INDEX, .pin = PIN5, .direction = INPUT};
