...
# 74 "MCAL_Layer/usart/../MCAL_std_types.h"
...
# 1 "MCAL_Layer/usart/../../MCAL_Layer/GPIO/HAL_GPIO_cfc.h" 1
# 16 "MCAL_Layer/usart/../../MCAL_Layer/GPIO/HAL_GPIO.h" 2
# 41 "MCAL_Layer/usart/../../MCAL_Layer/GPIO/HAL_GPIO.h"
typedef enum{
    LOW = 0,
    HIGH
}logic_t;
...
Std_ReturnType
EUSART_ASYNC_Init (const usart_t *_eusart) {
...
Std_ReturnType
EUSART_ASYNC_DeInit (const usart_t *_eusart) {
    Std_ReturnType ret = (Std_ReturnType)0x00;;
    if ( ((void*)0) == _eusart ) {
        ret = (Std_ReturnType)0x00;;
    }
...
Std_ReturnType
EUSART_ASYNC_ReadByteBlocking (uint8 *_data) {
    Std_ReturnType ret = (Std_ReturnType)0x00;;
    while ( ! PIR1bits.RCIF );
    *_data = RCREG;
    return ret;
...
Std_ReturnType
EUSART_ASYNC_ReadByteNonBlocking (uint8 *_data) {
    Std_ReturnType ret = (Std_ReturnType)0x00;;
    if ( 1 == PIR1bits.RCIF ) {
        *_data = RCREG;
        ret = (Std_ReturnType)0x01;;
...
Std_ReturnType
EUSART_ASYNC_WriteByteBlocking (uint8 _data) {
    Std_ReturnType ret = (Std_ReturnType)0x01;;
...
Std_ReturnType
EUSART_ASYNC_WriteStringBlocking (uint8 *_data, uint16 str_len) {
    Std_ReturnType ret = (Std_ReturnType)0x01;;
...
static void
EUSART_Baud_Rate_Calculation (const usart_t *_eusart) {
...
static void
EUSART_ASYNC_TX_Init (const usart_t *_eusart) {
...
static void
EUSART_ASYNC_RX_Init (const usart_t *_eusart) {
